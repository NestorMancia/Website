<%-- 
    Document   : index
    Created on : May 16, 2018, 1:29:49 PM
    Author     : Nestor Mancia
--%>
	...
	<body id="top">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-3 col-sm-4 col-xs-12">
                        <p><i class="fa fa-phone"></i><span>Telephone</span>503-7102-7397</p>
                    </div>
                    <div class="col-md-3 col-sm-4 col-xs-12">
                        <p><i class="fa fa-envelope-o"></i><span> Email</span><a href="#">Ledismolina@gmail.com</a></p>
                    </div>
                    <div class="col-md-5 col-sm-4 col-xs-12">
                        <ul class="social-icon">
                            <li><span>Follow me on</span></li>
		...
		<nav class="navbar navbar-default templatemo-nav" role="navigation">
			<div class="container">
				<div class="navbar-header">
					...
					<a href="#" class="navbar-brand">Ledis Molina</a>
				</div>
				<div class="collapse navbar-collapse">
					<ul class="nav navbar-nav navbar-right">
						<li><a href="#top">HOME</a></li>
						<li><a href="#about">ABOUT</a></li>
						<li><a href="#team">ME</a></li>
						<li><a href="#service">PROJECTS</a></li>
						<li><a href="#portfolio">BACKGROUND</a></li>
    		...
    		<div class="container">
    			<div class="row">
    				<div class="col-md-offset-2 col-md-8">
    					<h1 class="wow fadeIn" data-wow-offset="50" data-wow-delay="0.9s">I am focused on being <span>awesome</span></h1>
    					<div class="element">
                            <div class="sub-element">Hello, I am glad to work with you!</div>
                            <div class="sub-element">Awesome Caracters modeling and animation of different of them</div>
                            <div class="sub-element">Comminment and team work is all we are looking for</div>
                        </div>
		...
		<section id="about">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
    					<h2 class="wow bounceIn" data-wow-offset="50" data-wow-delay="0.3s">Modeling is <span>AWESOME</span></h2>
    				</div>
					<div class="col-md-4 col-sm-4 col-xs-12 wow fadeInLeft" data-wow-offset="50" data-wow-delay="0.6s">
						<div class="media">
							<div class="media-heading-wrapper">
								...
								<h3 class="media-heading">COMMITMENT</h3>
							</div>
							<div class="media-body">
								<p>My commitment with my projects and it functionality <a rel="nofollow" href="http://www.templatemo.com" target="_parent">Commitment</a> thats it.</p>
							</div>
						</div>
					</div>
					<div class="col-md-4 col-sm-4 col-xs-12 wow fadeInUp" data-wow-offset="50" data-wow-delay="0.9s">
						<div class="media">
							<div class="media-heading-wrapper">
								...
								<h3 class="media-heading">Team work</h3>
							</div>
							<div class="media-body">
								<p>All of us <a rel="nofollow" href="http://pixabay.com">working together </a> characters and full 3D animation <a rel="nofollow" href="http://unsplash.com"> make us</a> a big team.</p>
							</div>
						</div>
					</div>
				</div>
    	...
    	<section id="team">
    		<div class="container">
    			<div class="row">
    				<div class="col-md-12">
    					<h2 class="wow bounceIn" data-wow-offset="50" data-wow-delay="0.3s"><span>LEDIS</span> MOLINA</h2>
    				</div>
                ...
                <div class="row">
                    <div class="col-md-12 text-center">
                        <p class="wow bounceIn" data-wow-offset="50" data-wow-delay="0.3s">
                       	Copyright &copy; 2084 Ledis Molina</p>
                    </div>
                </div>
            </div>
        </footer>
